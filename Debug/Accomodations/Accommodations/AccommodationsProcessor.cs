...
public static class AccommodationsProcessor
{
    ...
    public static void Run()
    {
        ...
        string input;
        //Добавил также проверку на null, иначе программа выдаёт ошибку и падает
        while ( ( input = Console.ReadLine() ) != "exit" && input != null )
        {
            try
            {
    ...
    private static void ProcessCommand( string input )
    {
        ...
        switch ( commandName )
        {
            case "book":
                ...
                // Добавил исключение для неправильного ввода даты
                if ( !DateTime.TryParse( parts[ 3 ], out DateTime StartDate ) || !DateTime.TryParse( parts[ 4 ], out DateTime EndDate ) )
                {
                    throw new ArgumentException( "Date parsing error" );
                }

                // Добавил проверку валидности валюты
            ...
            case "cancel":
                ...
                // Добавил исключение для невалидного Booking ID
                ...
                break;
            case "undo":
                // Добавил проверку на пустой список комманд
